                ...
                <label for="email" className="block mb-2 text-2xl font-semibold bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent">Login</label>
                    ...
                    <div>
                        <div className="mb-5">
                            ...
                            <input type="email" name="email" placeholder="youremail@gmail.com" className="block w-full p-3 rounded bg-gray-200 border border-transparent focus:outline-none" 
                            value={email}
                        ...
                        <div className="mb-5">
                            ...
                            <input type="password" name="password" placeholder="********" className="block w-full p-3 rounded bg-gray-200 border border-transparent focus:outline-none" 
