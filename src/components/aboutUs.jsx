  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center bg-primary">
        ...
        <div class="w-full px-6 py-10 mx-auto">
          <div class="lg:flex lg:items-center">
            <div class="w-full space-y-12 lg:w-1/2 ">
              <div>
                ...
                <span className="text-2xl font-medium">
                  Our streaming system recognizes your emotions and creates
              ...
              <div class="md:flex md:items-start md:-mx-4">
                ...
                <div class="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p class="mt-3 text-gray-500 dark:text-gray-300">
                    ...
                    users' facial expressions and physiological signals to infer
              ...
              <div class="md:flex md:items-start md:-mx-4">
                ...
                <div class="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p class="mt-3 text-gray-500 dark:text-gray-300">
                    This information is used to personalize the music experience
                    and create playlists that match the users' moods.
                  </p>
                </div>
              </div>
            ...
            <div class="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
              <img
                class="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem] drop-shadow-md rounded-full"
                src={logo}
                alt=""
              />
            </div>
      ...
      <footer className="footer footer-center p-10 bg-orange-100 text-primary-content">
        <div>
          <img
            class="w-20 h-20 object-cover  drop-shadow-md "
            src={logo}
            alt=""
          />
